...
public partial class Yemekler : System.Web.UI.Page
{
    ...
    protected void btnEkle_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand komute2 = new SqlCommand("update Tbl_Kategoriler set kategoriAdet=kategoriAdet+1 where Kategoriid=@p1",bgl.baglanti());

        komute2.Parameters.AddWithValue("@p1",DropDownList1.SelectedValue);
        komute2.ExecuteNonQuery();
        bgl.baglanti().Close();
    }
}